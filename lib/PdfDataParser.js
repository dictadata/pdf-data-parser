...
module.exports = class PdfDataParser extends EventEmitter {
   ...
   * @param {URL|string}        options.url - the URL or local file name of the .pdf
   * @param {TypedArray|string} options.data - pdf file data as an array, instead of using url
  ...
  constructor(options = {}) {
    ...
    this.options = Object.assign({ cells: 1, trim: true, orderXY: true }, options);
