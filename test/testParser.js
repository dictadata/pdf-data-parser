...
(async () => {
  ...
  await test({ url: "./data/pdf/CoJul22.pdf", pageHeader: 50, pageFooter: 35, repeatingHeaders: true });
  await test({ url: "./data/pdf/CongJul22.pdf", pageHeader: 50, pageFooter: 35 });
})();
